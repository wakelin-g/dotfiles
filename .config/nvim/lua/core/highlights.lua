local color = require("core.color").dark
local faded = require("core.color").faded
...
local highlights = {
    ...
    StatusLine = { bg = color.bg0, fg = color.fg1 },
    StatusLineNC = { bg = color.bg0, fg = color.fg4 },
    ...
    --- <--------------> ---
    WinSeparator = { fg = color.bg3, bg = color.bg0_h },
    SignColumn = { bg = color.bg0 },
