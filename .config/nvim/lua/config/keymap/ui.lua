...
local plug_map = {
    -- Plugin: bufferline-cycle-windowless.nvim
    ["n|<S-l>"] = map_cr("BufferLineCycleWindowlessNext"):with_noremap():with_silent():with_desc("bufferline: Cycle next"),
    ["n|<S-h>"] = map_cr("BufferLineCycleWindowlessPrev"):with_noremap():with_silent():with_desc("bufferline: Cycle prev"),
    ["n|<S-t>"] = map_cr("BufferLineCycleWindowlessToggle"):with_noremap():with_silent():with_desc("bufferline: toggle all/windowless cycling"),
    ...
    ["n|zm"] = map_cr("ZenMode"):with_noremap():with_silent():with_desc("zen-mode: toggle"),
}
